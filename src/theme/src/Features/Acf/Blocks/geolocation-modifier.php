...
/**
 * Modificador de contexto para agregar datos de geolocalización
 */
class GeolocationContextModifier
{
	/**
	 * Registra el modificador de contexto para geolocalización
	 */
	public static function register(): void
	{
		BlockRenderer::registerContextModifier("geolocation", [self::class, "addGeolocationData"]);
	}

	/**
	 * Agrega datos de geolocalización al contexto
	 *
	 * @param array $context Contexto actual
	 * @return array Contexto modificado
	 */
	public static function addGeolocationData(array $context): array
	{
